...
libr/include/r_version.h:
	...
	@echo $(Q)#define R2_VERSION_MAJOR $(R2_VERSION_MAJOR) >> $@.tmp
	@echo $(Q)#define R2_VERSION_MINOR $(R2_VERSION_MINOR) >> $@.tmp
	@echo $(Q)#define R2_VERSION_PATCH $(R2_VERSION_PATCH) >> $@.tmp
