...
static int cb_color(void *user, void *data) {
	...
	r_cons_singleton ()->color = (node->i_value > COLORS_TRUECOLOR)? COLORS_TRUECOLOR: node->i_value;
...
// TODO: This should be specified at first by the debug backend when attaching
	...
	SETICB ("scr.color", (core->print->flags&R_PRINT_FLAGS_COLOR)?COLORS_ANSI:COLORS_DISABLED, &cb_color, "Enable colors (0: none, 1: ansi, 2: rgb, 3: truecolor)");
