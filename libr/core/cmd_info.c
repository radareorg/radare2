	...
	while (*input) {
		...
		case '?': {
			const char *help_message[] = {
				"Usage: i", "", "Получить информацию из открытого файла (см. Man-страницу rabin2)",
				"Output mode:", "", "",
				"'*'", "", "Вывод в командах radare",
				"'j'", "", "Вывод в json",
				"'q'", "", "Простой тихий вывод ",
				"Actions:", "", "",
				"i|ij", "", "Показать информацию о текущем файле (в JSON)",
				"iA", "", "Список archs",
				"ia", "", "Показать всю информацию (импорт, экспорт, разделы..)",
				"ib", "", "Обновить текущий буфер для установки bin (используйте только один раз)",
				"ic", "", "Список классов, методов и полей",
				"iC", "", "Показать подпись (права, ...)",
				"id", "", "Отладочная информация (исходные строки)",
				"iD", " lang sym", "Разбор имени символа для заданного языка",
				"ie", "", "Входная точка",
				"iE", "", "Экспорт (глобальные символы)",
				"ih", "", "Заголовки (псевдоним для iH)",
				"iHH", "", "Подробные заголовки в исходном тексте",
				"ii", "", "Импорт",
				"iI", "", "Двоичная информация",
				"ik", " [query]", "База данных с ключом из RBinObject",
				"il", "", "Библиотеки",
				"iL ", "[plugin]", "Список всех загруженных плагинов RBin  или детали плагинов",
				"im", "", "Показать информацию о предопределенном распределении памяти",
				"iM", "", "Показать основной адрес",
				"io", " [file]", "Загрузить информацию из файла (или последнего открытия) использовать bin.baddr ",
				"ir|iR", "", "Relocs",
                "is", "", "Символы",
				"iS ", "[entropy,sha1]", "Разделы (выберите используемый алгоритм хеширования)",
                "iV", "", "Отобразить информацию о версии файла",
				"iz|izj", "", "Строки в разделах данных (в JSON / Base64) ",
				"izz", "", "Поиск строк во всем двоичном ",
                "iZ", "", "Угадывает размер бинарной программы",
				NULL
			};
