...
static RCoreHelpMessage help_msg_dmh_jemalloc = {
	...
	"dmhc", "*|[arena_t]", "all chunks in all arenas, or one arena_t instance",
...
static RCoreHelpMessage help_msg_dm = {
	...
	"dm", " address size", "allocate bytes at address (-1 for anywhere)",
	"dm=", "", "list memory maps of target process (ascii-art bars)",
	"dm.", "", "show map name of current address",
	"dm*", "[-*]", "list memmaps in radare commands (dm** ioMap every debugMap, dm*- undoes)",
	"dm-", " address", "deallocate memory map of <address>",
	"dmd", "[aw] [file]", "dump current debug map region to file (see Sd)",
	...
	"dmp", "[?] <address> <size> <perms>", "change page protection at addr, size",
...
static RCoreHelpMessage help_msg_dmh_glibc = {
	...
	"dmhb", " @[malloc_state]", "all parsed double linked list of arena bins",
	"dmhb", " [bin_num|bin_num:malloc_state]", "parsed double linked list of bins",
	"dmhbg", " [bin_num]", "Display double linked list graph of main_arena's bin [Under developemnt]",
	"dmhc", " @[chunk_addr]", "Display malloc_chunk struct for a given malloc chunk",
	"dmhf", " @[malloc_state]", "all parsed fastbins of main_arena or arena",
	"dmhf", " [fastbin_num(:malloc_state)]", "single linked list in fastbinY",
