...
static RCoreHelpMessage help_msg_dmh_jemalloc = {
	...
	"dmhc", "*|[arena_t]", "show all chunks in all arenas, or for a given arena_t instance",
...
static RCoreHelpMessage help_msg_dm = {
	...
	"dm", " address size", "allocate size bytes at address (-1 for anywhere) in process",
	...
	"dmp", "[?] <address> <size> <perms>", "change page protection at address with size",
...
static RCoreHelpMessage help_msg_dmh_glibc = {
	...
	"dmhb", " @[malloc_state]", "Display all parsed double linked list of arena bins",
	...
	"dmhf", " @[malloc_state]", "Display all parsed fastbins of main_arena or arena",
	"dmhf", " [fastbin_num(:malloc_state)]", "Display single linked list in fastbinY",
