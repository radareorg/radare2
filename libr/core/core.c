...
static void init_autocomplete (RCore* core) {
	...
	r_core_autocomplete_add (core->autocomplete, "#!python2", R_CORE_AUTOCMPLT_FILE, true);
	r_core_autocomplete_add (core->autocomplete, "#!python3", R_CORE_AUTOCMPLT_FILE, true);
