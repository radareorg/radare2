...
static void cmd_write_inc(RCore *core, int size, st64 num) {
	...
	switch (size) {
	case 1: core->block[0] += num; break;
	case 2: r_write_ble16 (core->block, r_read_ble16 (core->block, be) + num, be); break;
	case 4: r_write_ble32 (core->block, r_read_ble32 (core->block, be) + num, be); break;
	case 8: r_write_ble64 (core->block, r_read_ble64 (core->block, be) + num, be); break;
	}
