...
R_API int r_anal_esil_to_reil_setup(RAnalEsil *esil, RAnal *anal, int romem,
	...
	r_anal_esil_set_op(esil, "=", reil_eq, 0, 2);
	r_anal_esil_set_op(esil, "+", reil_add, 1, 2);
	r_anal_esil_set_op(esil, "+=", reil_addeq, 0, 2);
	r_anal_esil_set_op(esil, "-", reil_sub, 1, 2);
	r_anal_esil_set_op(esil, "-=", reil_subeq, 0, 2);
	r_anal_esil_set_op(esil, "*", reil_mul, 1, 2);
	r_anal_esil_set_op(esil, "*=", reil_muleq, 0, 2);
	r_anal_esil_set_op(esil, "/", reil_div, 1, 2);
	r_anal_esil_set_op(esil, "/=", reil_diveq, 0, 2);
	r_anal_esil_set_op(esil, "^", reil_xor, 1, 2);
	r_anal_esil_set_op(esil, "^=", reil_xoreq, 0, 2);
	r_anal_esil_set_op(esil, "|", reil_or, 1, 2);
	r_anal_esil_set_op(esil, "|=", reil_oreq, 0, 2);
	r_anal_esil_set_op(esil, "&", reil_and, 1, 2);
	r_anal_esil_set_op(esil, "&=", reil_andeq, 0, 2);
	r_anal_esil_set_op(esil, "<<", reil_lsl, 1, 2);
	r_anal_esil_set_op(esil, "<<=", reil_lsleq, 0, 2);
	r_anal_esil_set_op(esil, ">>", reil_lsr, 1, 2);
	r_anal_esil_set_op(esil, ">>=", reil_lsreq, 0, 2);
	r_anal_esil_set_op(esil, "++=", reil_inceq, 0, 1);
	r_anal_esil_set_op(esil, "++", reil_inc, 1, 1);
	r_anal_esil_set_op(esil, "--=", reil_deceq, 0, 1);
	r_anal_esil_set_op(esil, "--", reil_dec, 1, 1);
	r_anal_esil_set_op(esil, "!", reil_neg, 1, 1);
	r_anal_esil_set_op(esil, "!=", reil_negeq, 0, 1);
	r_anal_esil_set_op(esil, "==", reil_cmp, 0, 2);
	r_anal_esil_set_op(esil, "<", reil_smaller, 1, 2);
	r_anal_esil_set_op(esil, ">", reil_larger, 1, 2);
	r_anal_esil_set_op(esil, "<=", reil_smaller_equal, 1, 2);
	r_anal_esil_set_op(esil, ">=", reil_larger_equal, 1, 2);
	r_anal_esil_set_op(esil, "[]", reil_peek, 1, 1);
	r_anal_esil_set_op(esil, "=[]", reil_poke, 0, 2);
	r_anal_esil_set_op(esil, "|=[]", reil_mem_oreq, 0, 2);
	r_anal_esil_set_op(esil, "^=[]", reil_mem_xoreq, 0, 2);
	r_anal_esil_set_op(esil, "&=[]", reil_mem_andeq, 0, 2);
	r_anal_esil_set_op(esil, "+=[]", reil_mem_addeq, 0, 2);
	r_anal_esil_set_op(esil, "-=[]", reil_mem_subeq, 0, 2);
	r_anal_esil_set_op(esil, "*=[]", reil_mem_muleq, 0, 2);
	r_anal_esil_set_op(esil, "++=[]", reil_mem_inceq, 0, 1);
	r_anal_esil_set_op(esil, "--=[]", reil_mem_deceq, 0, 1);
	r_anal_esil_set_op(esil, "=[1]", reil_poke1, 0, 2);
	r_anal_esil_set_op(esil, "=[2]", reil_poke2, 0, 2);
	r_anal_esil_set_op(esil, "=[4]", reil_poke4, 0, 2);
	r_anal_esil_set_op(esil, "=[8]", reil_poke8, 0, 2);
	r_anal_esil_set_op(esil, "[1]", reil_peek1, 1, 1);
	r_anal_esil_set_op(esil, "[2]", reil_peek2, 1, 1);
	r_anal_esil_set_op(esil, "[4]", reil_peek4, 1, 1);
	r_anal_esil_set_op(esil, "[8]", reil_peek8, 1, 1);
	r_anal_esil_set_op(esil, "|=[1]", reil_mem_oreq1, 0, 2);
	r_anal_esil_set_op(esil, "|=[2]", reil_mem_oreq2, 0, 2);
	r_anal_esil_set_op(esil, "|=[4]", reil_mem_oreq4, 0, 2);
	r_anal_esil_set_op(esil, "|=[8]", reil_mem_oreq8, 0, 2);
	r_anal_esil_set_op(esil, "^=[1]", reil_mem_xoreq1, 0, 2);
	r_anal_esil_set_op(esil, "^=[2]", reil_mem_xoreq2, 0, 2);
	r_anal_esil_set_op(esil, "^=[4]", reil_mem_xoreq4, 0, 2);
	r_anal_esil_set_op(esil, "^=[8]", reil_mem_xoreq8, 0, 2);
	r_anal_esil_set_op(esil, "&=[1]", reil_mem_andeq1, 0, 2);
	r_anal_esil_set_op(esil, "&=[2]", reil_mem_andeq2, 0, 2);
	r_anal_esil_set_op(esil, "&=[4]", reil_mem_andeq4, 0, 2);
	r_anal_esil_set_op(esil, "&=[8]", reil_mem_andeq8, 0, 2);
	r_anal_esil_set_op(esil, "+=[1]", reil_mem_addeq1, 0, 2);
	r_anal_esil_set_op(esil, "+=[2]", reil_mem_addeq2, 0, 2);
	r_anal_esil_set_op(esil, "+=[4]", reil_mem_addeq4, 0, 2);
	r_anal_esil_set_op(esil, "+=[8]", reil_mem_addeq8, 0, 2);
	r_anal_esil_set_op(esil, "-=[1]", reil_mem_subeq1, 0, 2);
	r_anal_esil_set_op(esil, "-=[2]", reil_mem_subeq2, 0, 2);
	r_anal_esil_set_op(esil, "-=[4]", reil_mem_subeq4, 0, 2);
	r_anal_esil_set_op(esil, "-=[8]", reil_mem_subeq8, 0, 2);
	r_anal_esil_set_op(esil, "*=[1]", reil_mem_muleq1, 0, 2);
	r_anal_esil_set_op(esil, "*=[2]", reil_mem_muleq2, 0, 2);
	r_anal_esil_set_op(esil, "*=[4]", reil_mem_muleq4, 0, 2);
	r_anal_esil_set_op(esil, "*=[8]", reil_mem_muleq8, 0, 2);
	r_anal_esil_set_op(esil, "++=[1]", reil_mem_inceq1, 0, 1);
	r_anal_esil_set_op(esil, "++=[2]", reil_mem_inceq2, 0, 1);
	r_anal_esil_set_op(esil, "++=[4]", reil_mem_inceq4, 0, 1);
	r_anal_esil_set_op(esil, "++=[8]", reil_mem_inceq8, 0, 1);
	r_anal_esil_set_op(esil, "--=[1]", reil_mem_deceq1, 0, 1);
	r_anal_esil_set_op(esil, "--=[2]", reil_mem_deceq2, 0, 1);
	r_anal_esil_set_op(esil, "--=[4]", reil_mem_deceq4, 0, 1);
	r_anal_esil_set_op(esil, "--=[8]", reil_mem_deceq8, 0, 1);
	r_anal_esil_set_op(esil, "?{", reil_if, 0, 1);
	r_anal_esil_set_op(esil, "}", reil_if_end, 0, 0);
