...
static bool reil_add (RAnalEsil *esil) {
	return reil_binop (esil, REIL_ADD);
}
static bool reil_addeq (RAnalEsil *esil) {
	return reil_bineqop (esil, REIL_ADD);
}
static bool reil_mul (RAnalEsil *esil) {
	return reil_binop (esil, REIL_MUL);
}
static bool reil_muleq (RAnalEsil *esil) {
	return reil_bineqop (esil, REIL_MUL);
}
static bool reil_sub (RAnalEsil *esil) {
	return reil_binop (esil, REIL_SUB);
}
static bool reil_subeq (RAnalEsil *esil) {
	return reil_bineqop (esil, REIL_SUB);
}
static bool reil_div (RAnalEsil *esil) {
	return reil_binop (esil, REIL_DIV);
}
static bool reil_diveq (RAnalEsil *esil) {
	return reil_bineqop (esil, REIL_DIV);
}
static bool reil_xor (RAnalEsil *esil) {
	return reil_binop (esil, REIL_XOR);
}
static bool reil_xoreq (RAnalEsil *esil) {
	return reil_bineqop (esil, REIL_XOR);
}
static bool reil_and (RAnalEsil *esil) {
	return reil_binop (esil, REIL_AND);
}
static bool reil_andeq (RAnalEsil *esil) {
	return reil_bineqop (esil, REIL_AND);
}
static bool reil_or (RAnalEsil *esil) {
	return reil_binop (esil, REIL_OR);
}
static bool reil_oreq (RAnalEsil *esil) {
	return reil_bineqop (esil, REIL_OR);
}
static bool reil_lsl (RAnalEsil *esil) {
	return reil_binop (esil, REIL_SHL);
}
static bool reil_lsleq (RAnalEsil *esil) {
	return reil_bineqop (esil, REIL_SHL);
}
static bool reil_lsr (RAnalEsil *esil) {
	return reil_binop (esil, REIL_SHR);
}
static bool reil_lsreq (RAnalEsil *esil) {
	return reil_bineqop (esil, REIL_SHR);
}
static bool reil_smaller (RAnalEsil *esil) {
...
static bool reil_if_end (RAnalEsil *esil) {
	return true;
}
...
static bool reil_peek1 (RAnalEsil *esil) {
	return reil_peekn (esil, 1);
}
static bool reil_peek2 (RAnalEsil *esil) {
	return reil_peekn (esil, 2);
}
static bool reil_peek4 (RAnalEsil *esil) {
	return reil_peekn (esil, 4);
}
static bool reil_peek8 (RAnalEsil *esil) {
...
static bool reil_poke1 (RAnalEsil *esil) {
	return reil_poken (esil, 1);
}
static bool reil_poke2 (RAnalEsil *esil) {
	return reil_poken (esil, 2);
}
static bool reil_poke4 (RAnalEsil *esil) {
	return reil_poken (esil, 4);
}
static bool reil_poke8 (RAnalEsil *esil) {
...
static bool reil_mem_oreq (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_OR, esil->anal->bits / 8);
}
static bool reil_mem_oreq1 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_OR, 1);
}
static bool reil_mem_oreq2 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_OR, 2);
}
static bool reil_mem_oreq4 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_OR, 4);
}
static bool reil_mem_oreq8 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_OR, 8);
}

static bool reil_mem_andeq (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_AND, esil->anal->bits / 8);
}
static bool reil_mem_andeq1 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_AND, 1);
}
static bool reil_mem_andeq2 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_AND, 2);
}
static bool reil_mem_andeq4 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_AND, 4);
}
static bool reil_mem_andeq8 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_AND, 8);
}

static bool reil_mem_xoreq (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_XOR, esil->anal->bits / 8);
}
static bool reil_mem_xoreq1 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_XOR, 1);
}
static bool reil_mem_xoreq2 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_XOR, 2);
}
static bool reil_mem_xoreq4 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_XOR, 4);
}
static bool reil_mem_xoreq8 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_XOR, 8);
}

static bool reil_mem_addeq (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_ADD, esil->anal->bits / 8);
}
static bool reil_mem_addeq1 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_ADD, 1);
}
static bool reil_mem_addeq2 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_ADD, 2);
}
static bool reil_mem_addeq4 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_ADD, 4);
}
static bool reil_mem_addeq8 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_ADD, 8);
}

static bool reil_mem_subeq (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_SUB, esil->anal->bits / 8);
}
static bool reil_mem_subeq1 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_SUB, 1);
}
static bool reil_mem_subeq2 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_SUB, 2);
}
static bool reil_mem_subeq4 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_SUB, 4);
}
static bool reil_mem_subeq8 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_SUB, 8);
}

static bool reil_mem_muleq (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_MUL, esil->anal->bits / 8);
}
static bool reil_mem_muleq1 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_MUL, 1);
}
static bool reil_mem_muleq2 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_MUL, 2);
}
static bool reil_mem_muleq4 (RAnalEsil *esil) {
	return reil_mem_bineq_n (esil, REIL_MUL, 4);
}
static bool reil_mem_muleq8 (RAnalEsil *esil) {
...
static bool reil_mem_inceq1 (RAnalEsil *esil) {
	return reil_mem_inceq_n (esil, 1);
}
static bool reil_mem_inceq2 (RAnalEsil *esil) {
	return reil_mem_inceq_n (esil, 2);
}
static bool reil_mem_inceq4 (RAnalEsil *esil) {
	return reil_mem_inceq_n (esil, 4);
}
static bool reil_mem_inceq8 (RAnalEsil *esil) {
...
static bool reil_mem_deceq1 (RAnalEsil *esil) {
	return reil_mem_deceq_n (esil, 1);
}
static bool reil_mem_deceq2 (RAnalEsil *esil) {
	return reil_mem_deceq_n (esil, 2);
}
static bool reil_mem_deceq4 (RAnalEsil *esil) {
	return reil_mem_deceq_n (esil, 4);
}
static bool reil_mem_deceq8 (RAnalEsil *esil) {
