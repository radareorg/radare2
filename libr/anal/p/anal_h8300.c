...
static int analop_esil(RAnal *a, RAnalOp *op, ut64 addr, const ut8 *buf) {
	...
	switch (opcode >> 4) {
	  ...
	  case H8300_SUBX_4BIT:
	    //Rd – imm – C → Rd
	    r_strbuf_appendf(&op->esil, "0x%02x,r%u%c,-=,C,r%u%c,-=", imm, 
	     rdB(0), rdB(0));
	    //setZ
	    setV("%o")
	    setN
	...
	switch (opcode) {
	  case H8300_NOP: 
	    r_strbuf_set (&op->esil, ","); 
	    return 0;
	  case H8300_SLEEP: /* TODO */ return 0;
	  case H8300_STC: 
	  ...
	  case H8300_ADDX: 
	    ...
	    setZ
	    return 0;
	  case H8300_DAA: /*TODO*/ return 0;
	  case H8300_SHL: /*TODO*/ return 0;
	  case H8300_SHR: /*TODO*/ return 0;
	  case H8300_ROTL: /*TODO*/ return 0;
	  case H8300_ROTR: /*TODO*/ return 0;
	  case H8300_OR: 
	    r_strbuf_appendf(&op->esil, "r%u%c,r%u%c,|=", rsB(), rdB(1));
	    //setZ
	    setV("0") 
	  ...
	  case H8300_MOV_DISP162R16: /*TODO*/ return 0;
