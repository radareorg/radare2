...
#define PRINTF_YA(fmt, ...) PRINTF_A ("%s", fmt, core->cons->context->pal.offset, __VA_ARGS__)
#define PRINTF_GA(fmt, ...) PRINTF_A ("%s", fmt, core->cons->context->pal.args, __VA_ARGS__)
#define PRINTF_BA(fmt, ...) PRINTF_A ("%s", fmt, core->cons->context->pal.num, __VA_ARGS__)
#define PRINTF_RA(fmt, ...) PRINTF_A ("%s", fmt, core->cons->context->pal.invalid, __VA_ARGS__)

#define PRINT_A(color, msg) r_cons_print (color msg Color_RESET)
#define PRINT_YA(msg) r_cons_printf ("%s" msg Color_RESET, core->cons->context->pal.offset)
#define PRINT_GA(msg) r_cons_printf ("%s" msg Color_RESET, core->cons->context->pal.args)
#define PRINT_BA(msg) r_cons_printf ("%s" msg Color_RESET, core->cons->context->pal.num)
#define PRINT_RA(msg) r_cons_printf ("%s" msg Color_RESET, core->cons->context->pal.invalid)
