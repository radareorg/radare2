...
#define r_utf8_to_utf16(cstring) r_utf8_to_utf16_l ((ut8 *)cstring, -1)
#if __WINDOWS__
R_API char *r_acp_to_utf8_l (const ut8 *str, int len);
R_API char *r_utf8_to_acp_l(const ut8 *str, int len);
#define r_acp_to_utf8(str) r_acp_to_utf8_l ((ut8 *)str, -1)
#define r_utf8_to_acp(cstring) r_utf8_to_acp_l ((ut8 *)cstring, -1)
#endif // __WINDOWS__
