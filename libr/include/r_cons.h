...
#else
#define RCOLOR(a, r, g, b, bgr, bgg, bgb, id16) \
	(RColor) { 0, a, r, g, b, bgr, bgg, bgb, id16 }
#endif
...
typedef enum { R_LINE_PROMPT_DEFAULT,
	R_LINE_PROMPT_OFFSET,
	R_LINE_PROMPT_FILE } RLinePromptType;
