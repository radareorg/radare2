			...
			if (*arg2 == '[') {
				...
				if (sib) {
					*sib++ = 0;
					...
					if ((ST8_MIN > d) && (d > ST8_MAX)) rm_byte = 0x80;
					data[l++] = getreg (arg) << 3 | r | rm_byte;
					if (r == 4) data[l++] = 0x24; // ESP
					data[l++] = d;
