...
insn_extra_t extra_0x5[] = {
	{(0x05<<26)|(0x1<<24), "l.nop", INSN_K, INSN_OPCODE_MASK | (0x3 << 24), R_ARCH_OP_TYPE_NOP},
	{0}
};
...
insn_t or1k_insns[] = {
	[0x00] = {(0x00<<26), "l.j", INSN_N, R_ARCH_OP_TYPE_JMP},
	[0x01] = {(0x01<<26), "l.jal", INSN_N, R_ARCH_OP_TYPE_CALL},
	[0x02] = {(0x02<<26), "l.adrp", INSN_DN},
	[0x03] = {(0x03<<26), "l.bnf", INSN_N, R_ARCH_OP_TYPE_CJMP},
	[0x04] = {(0x04<<26), "l.bf", INSN_N, R_ARCH_OP_TYPE_CJMP},
	[0x05] = {(0x05<<26), NULL, INSN_X, R_ARCH_OP_TYPE_NULL, extra_0x5},
	[0x06] = {(0x06<<26), NULL, INSN_X, R_ARCH_OP_TYPE_NULL, extra_0x6},
	[0x07] = {(0x07<<26)},
	[0x08] = {(0x08<<26), NULL, INSN_X, R_ARCH_OP_TYPE_NULL, extra_0x8},
	...
	[0x0f] = {(0x0f<<26)},
	[0x10] = {(0x10<<26)},
	[0x11] = {(0x11<<26), "l.jr", INSN_B, R_ARCH_OP_TYPE_JMP},
	[0x12] = {(0x12<<26), "l.jalr", INSN_B, R_ARCH_OP_TYPE_CALL},
	...
	[0x27] = {(0x27<<26), "l.addi", INSN_DAI, R_ARCH_OP_TYPE_LOAD},
	[0x28] = {(0x28<<26), "l.addic", INSN_DAI},
	[0x29] = {(0x29<<26), "l.andi", INSN_DAK},
	[0x2a] = {(0x2a<<26), "l.ori", INSN_DAK, R_ARCH_OP_TYPE_LOAD},
	[0x2b] = {(0x2b<<26), "l.xori", INSN_DAI},
	[0x2c] = {(0x2c<<26), "l.muli", INSN_DAI},
	[0x2d] = {(0x2d<<26), "l.mfspr", INSN_DAK},
	[0x2e] = {(0x2e<<26), NULL, INSN_X, R_ARCH_OP_TYPE_NULL, extra_0x2e},
	[0x2f] = {(0x2f<<26), NULL, INSN_X, R_ARCH_OP_TYPE_NULL, extra_0x2f},
	[0x30] = {(0x30<<26), "l.mtspr", INSN_KABK},
	[0x31] = {(0x31<<26), NULL, INSN_X, R_ARCH_OP_TYPE_NULL, extra_0x31},
	[0x32] = {(0x32<<26), NULL, INSN_X, R_ARCH_OP_TYPE_NULL, extra_0x32},
	[0x33] = {(0x33<<26), "l.swa", INSN_IABI},
	[0x34] = {(0x34<<26)},
	[0x35] = {(0x35<<26), "l.sw", INSN_IABI},
	[0x36] = {(0x36<<26), "l.sb", INSN_IABI},
	[0x37] = {(0x37<<26), "l.sh", INSN_IABI},
	[0x38] = {(0x38<<26), NULL, INSN_X, R_ARCH_OP_TYPE_NULL, extra_0x38},
	[0x39] = {(0x39<<26), NULL, INSN_X, R_ARCH_OP_TYPE_NULL, extra_0x39},
	[0x3a] = {(0x3a<<26)},
	[0x3b] = {(0x3b<<26)},
