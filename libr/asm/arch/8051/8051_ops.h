...
static _8051_op_t _8051_ops[] = {
	...
	{0x10, OP_JBC, "jbc 0x%02x, 0x%04x", 3, M_NONE, A_BIT, A_OFFSET, 0},
	...
	{0x20, OP_JB, "jb 0x%02x, 0x%04x", 3, M_NONE, A_BIT, A_OFFSET, 0},
	...
	{0x30, OP_JNB, "jnb 0x%02x, 0x%04x", 3, M_NONE, A_BIT, A_OFFSET, 0},
	...
	{0x56, OP_ANL, "anl a, @r%d", 2, M_RI, A_RI, 0, 0},
	{0x58, OP_ANL, "anl a, r%d", 2, M_RN, A_RN, 0, 0},
	...
	{0x66, OP_XRL, "xrl a, @r%d", 2, M_RI, A_RI, 0, 0},
	{0x68, OP_XRL, "xrl a, r%d", 2, M_RN, A_RN, 0, 0},
	{0x70, OP_JNZ, "jnz 0x%04x", 2, M_NONE, A_OFFSET, 0, 0},
	{0x72, OP_ORL, "orl c, 0x%02x", 2, M_NONE, A_BIT, 0, 0},
	...
	{0x82, OP_ANL, "anl c, 0x%02x", 2, M_NONE, A_BIT, 0, 0},
	...
	{0x92, OP_MOV, "mov 0x%02x, c", 2, M_NONE, A_BIT, 0, 0},
	...
	{0xa0, OP_ORL, "orl c, /0x%02x", 2, M_NONE, A_BIT, 0, 0},
	{0xa2, OP_MOV, "mov c, 0x%02x", 2, M_NONE, A_BIT, 0, 0},
	...
	{0xb0, OP_ANL, "anl c, /0x%02x", 2, M_NONE, A_BIT, 0, 0},
	{0xb2, OP_CPL, "cpl 0x%02x", 2, M_NONE, A_BIT, 0, 0},
	...
	{0xc2, OP_CLR, "clr 0x%02x", 2, M_NONE, A_BIT, 0, 0},
	...
	{0xd2, OP_SETB, "setb 0x%02x", 2, M_NONE, A_BIT, 0, 0},
