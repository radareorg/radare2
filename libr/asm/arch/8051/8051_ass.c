...
static bool is_indirect_reg (char const *str) {
	...
	if (str[0] == '@') {
		return r_str_ansi_nlen (str, 4) == 3 && tolower (str[1]) == 'r' && (str[2] == '0' || str[2] == '1');
	}

	if (str[0] == '[') {
		return r_str_ansi_nlen (str, 5) == 4 && tolower (str[1]) == 'r' && (str[2] == '0' || str[2] == '1') && str[3] == ']';
	}
...
static bool is_reg (char const *str) {
	return str && tolower (str[0]) == 'r' && r_str_ansi_nlen (str, 3) == 2 && '0' <= str[1] && str[1] <= '7';
}
