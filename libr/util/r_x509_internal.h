...
R_API char* r_x509_validity_dump (RX509Validity* validity, const char* pad);
R_API char* r_x509_name_dump (RX509Name* name, const char* pad);
R_API char* r_x509_subjectpublickeyinfo_dump (RX509SubjectPublicKeyInfo* spki, const char* pad);
R_API char* r_x509_extensions_dump (RX509Extensions* exts, const char* pad);
R_API char* r_x509_tbscertificate_dump (RX509TBSCertificate* tbsc, const char* pad);
