...
R_API void r_print_addr(RPrint *p, ut64 addr) {
	...
	const char *white = "";
#define PREOFF(x) (p && p->cons && p->cons->context->pal.x)? p->cons->context->pal.x
...
R_API const char* r_print_color_op_type(RPrint *p, ut64 anal_type) {
	...
	case R_ANAL_OP_TYPE_LENGTH:
		return p->cons->context->pal.math;
	...
	case R_ANAL_OP_TYPE_CPL:
		return p->cons->context->pal.bin;
	case R_ANAL_OP_TYPE_IO:
		return p->cons->context->pal.swi;
	...
	case R_ANAL_OP_TYPE_MJMP:
		return p->cons->context->pal.jmp;
	case R_ANAL_OP_TYPE_CJMP:
	case R_ANAL_OP_TYPE_UCJMP:
	case R_ANAL_OP_TYPE_SWITCH:
		return p->cons->context->pal.cjmp;
	case R_ANAL_OP_TYPE_CMP:
	case R_ANAL_OP_TYPE_ACMP:
		return p->cons->context->pal.cmp;
	...
	case R_ANAL_OP_TYPE_CCALL:
		return p->cons->context->pal.call;
	case R_ANAL_OP_TYPE_NEW:
	case R_ANAL_OP_TYPE_SWI:
		return p->cons->context->pal.swi;
	case R_ANAL_OP_TYPE_ILL:
	case R_ANAL_OP_TYPE_TRAP:
		return p->cons->context->pal.trap;
	case R_ANAL_OP_TYPE_CRET:
	case R_ANAL_OP_TYPE_RET:
		return p->cons->context->pal.ret;
	case R_ANAL_OP_TYPE_CAST:
	case R_ANAL_OP_TYPE_MOV:
	case R_ANAL_OP_TYPE_LEA:
	case R_ANAL_OP_TYPE_CMOV: // TODO: add cmov cathegory?
		return p->cons->context->pal.mov;
	case R_ANAL_OP_TYPE_PUSH:
	case R_ANAL_OP_TYPE_UPUSH:
	case R_ANAL_OP_TYPE_LOAD:
		return p->cons->context->pal.push;
	case R_ANAL_OP_TYPE_POP:
	case R_ANAL_OP_TYPE_STORE:
		return p->cons->context->pal.pop;
	case R_ANAL_OP_TYPE_CRYPTO:
		return p->cons->context->pal.crypto;
	case R_ANAL_OP_TYPE_NULL:
		return p->cons->context->pal.other;
	case R_ANAL_OP_TYPE_UNK:
	default:
		return p->cons->context->pal.invalid;
	}
}
