...
static const RFSType fstypes[] = {
	...
	{ "apfs", 0x5020, "\x4e\x58\x53\x42", 4, 0, 0, 0 },
...
R_API R_MUSTUSE RFS *r_fs_new(void) {
	...
	r_libstore_new (&fs->libstore, fs, fs_static_plugins, (RListFree)free, NULL, (RLibPluginAddCb)r_fs_plugin_add);
	return fs;
}
