...
static i8080_opcode_t i8080_opcodes[] = {
	...
	{ R_ANAL_OP_TYPE_MOV, 1, "mvi", { 3, 3, 7, reg }, { 1 } },  	//0x0e
	...
	{ R_ANAL_OP_TYPE_MOV, 1, "mvi", { 3, 3, 7, reg }, { 1 } },  	//0x1e
	...
	{ R_ANAL_OP_TYPE_MOV, 1, "mvi", { 3, 3, 7, reg }, { 1 } },  	//0x2e
	...
	{ R_ANAL_OP_TYPE_MOV, 1, "mvi", { 3, 3, 7, reg }, { 1 } },  	//0x3e
	...
	{ R_ANAL_OP_TYPE_RET, 1, "ret", { 3, 0, 7, reg } },  //0xc9
	...
	{ R_ANAL_OP_TYPE_UNK, 1, "invalid", { 1 } },             //0xe3 ilegal opcode
