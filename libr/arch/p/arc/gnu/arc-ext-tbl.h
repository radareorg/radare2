...
EXTINSN2OP ("dsp_fp_flt2i",  ARC_OPCODE_ARCv2EM, ARC_FLOAT, QUARKSE1, 7, 43)
EXTINSN2OP ("dsp_fp_i2flt",  ARC_OPCODE_ARCv2EM, ARC_FLOAT, QUARKSE1, 7, 44)
EXTINSN2OP ("dsp_fp_sqrt",   ARC_OPCODE_ARCv2EM, ARC_FLOAT, QUARKSE2, 7, 45)

EXTINSN3OP ("dsp_fp_div", ARC_OPCODE_ARCv2EM, ARC_FLOAT, QUARKSE2, 7, 42)
EXTINSN3OP ("dsp_fp_cmp", ARC_OPCODE_ARCv2EM, ARC_FLOAT, QUARKSE1, 7, 43)
