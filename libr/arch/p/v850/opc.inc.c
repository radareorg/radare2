...
const struct v850_opcode v850_opcodes[] = {
	...
	{ "div", two (0x07e0, 0x02c0), two (0x07e0, 0x07ff), {R1, R2, R3}, 0, V850_CPU_NON0, R_ANAL_OP_TYPE_DIV, "" },
	...
	{ "mulh", OP (0x17), OP_MASK, {I5, R2_NOTR0}, 0, V850_CPU_ALL , R_ANAL_OP_TYPE_MUL, "#0,#1,*,#1,:=" },
	{ "mulh", OP (0x07), OP_MASK, {R1, R2_NOTR0}, 0, V850_CPU_ALL , R_ANAL_OP_TYPE_MUL, "#0,#1,*,#1,:=" },
	{ "mulhi", OP (0x37), OP_MASK, {I16, R1, R2_NOTR0}, 0, V850_CPU_ALL , R_ANAL_OP_TYPE_MUL, "#0,#1,*,#2,:=" },
	...
	{ "sar", two (0x07e0, 0x00a2), two (0x07e0, 0x07ff), {R1, R2, R3}, 0, V850_CPU_E2_UP, R_ANAL_OP_TYPE_SAR, "#0,1,-,#1,>>,1,&,cy,:=,#0,#1,ASR,#2,=,31,$s,s,:=,$z,z,:=,0,ov,:=" },
	{ "sar", OP (0x15), OP_MASK, {I5U, R2}, 0, V850_CPU_ALL, R_ANAL_OP_TYPE_SAR, "#0,1,-,#1,>>,1,&,cy,:=,#0,#1,ASR,#1,=,31,$s,s,:=,$z,z,:=,0,ov,:=" },
	{ "sar", two (0x07e0, 0x00a0), two (0x07e0, 0xffff), {R1, R2}, 0, V850_CPU_ALL, R_ANAL_OP_TYPE_SAR, "#0,1,-,#1,>>,1,&,cy,:=,#0,#1,ASR,#1,=,31,$s,s,:=,$z,z,:=,0,ov,:=" },
	...
	{ "shl", two (0x07e0, 0x00c2), two (0x07e0, 0x07ff), {R1, R2, R3}, 0, V850_CPU_E2_UP, R_ANAL_OP_TYPE_SHL, "#1,32,#0,-,>>,1,&,cy,:=,#1,#2,=,#0,#2,<<=,31,$s,s,:=,$z,z,:=,0,ov,:=" },
	{ "shl", OP (0x16), OP_MASK, {I5U, R2}, 0, V850_CPU_ALL, R_ANAL_OP_TYPE_SHL, "#1,32,#0,-,>>,1,&,cy,:=,#0,#1,<<=,31,$s,s,:=,$z,z,:=,0,ov,:=" },
	{ "shl", two (0x07e0, 0x00c0), two (0x07e0, 0xffff), {R1, R2}, 0, V850_CPU_ALL, R_ANAL_OP_TYPE_SHL, "#1,32,#0,-,>>,1,&,cy,:=,#0,#1,<<=,31,$s,s,:=,$z,z,:=,0,ov,:=" },
	{ "shr", two (0x07e0, 0x0082), two (0x07e0, 0x07ff), {R1, R2, R3}, 0, V850_CPU_E2_UP, R_ANAL_OP_TYPE_SHR, "#1,#0,1,-,>>,1,&,cy,:=,#1,#2,=,#0,#2,>>=,31,$s,s,:=,$z,z,:=,0,ov,:=" },
	{ "shr", OP (0x14), OP_MASK, {I5U, R2}, 0, V850_CPU_ALL, R_ANAL_OP_TYPE_SHR, "#1,#0,1,-,>>,1,&,cy,:=,#0,#1,>>=,31,$s,s,:=,$z,z,:=,0,ov,:=" },
	{ "shr", two (0x07e0, 0x0080), two (0x07e0, 0xffff), {R1, R2}, 0, V850_CPU_ALL, R_ANAL_OP_TYPE_SHR, "#1,#0,1,-,>>,1,&,cy,:=,#0,#1,>>=,31,$s,s,:=,$z,z,:=,0,ov,:=" },
