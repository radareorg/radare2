...
const struct v850_opcode v850_opcodes[] = {
	...
	{ "shl", two (0x07e0, 0x00c2), two (0x07e0, 0x07ff), {R1, R2, R3}, 0, V850_CPU_E2_UP, R_ANAL_OP_TYPE_SHL, "#1,tmp,:=,32,#0,-,tmp,>>,1,&,cy,:=,#1,#2,:=,#0,#2,<<=,$z,31,$s,s,:=,z,:=,0,ov,:=" },
	{ "shl", OP (0x16), OP_MASK, {I5U, R2}, 0, V850_CPU_ALL, R_ANAL_OP_TYPE_SHL, "#1,tmp,:=,32,#0,-,tmp,>>,1,&,cy,:=,#0,#1,<<=,$z,31,$s,s,:=,z,:=,0,ov,:=" },
	{ "shl", two (0x07e0, 0x00c0), two (0x07e0, 0xffff), {R1, R2}, 0, V850_CPU_ALL, R_ANAL_OP_TYPE_SHL, "#1,tmp,:=,32,#0,-,tmp,>>,1,&,cy,:=,#0,#1,<<=,$z,31,$s,s,:=,z,:=,0,ov,:=" },
	{ "shr", two (0x07e0, 0x0082), two (0x07e0, 0x07ff), {R1, R2, R3}, 0, V850_CPU_E2_UP, R_ANAL_OP_TYPE_SHR, "#1,tmp,:=,#0,1,-,tmp,>>,1,&,cy,:=,#1,#2,:=,#0,#2,>>=,$z,31,$s,s,:=,z,:=,0,ov,:=" },
	{ "shr", OP (0x14), OP_MASK, {I5U, R2}, 0, V850_CPU_ALL, R_ANAL_OP_TYPE_SHR, "#1,tmp,:=,#0,1,-,tmp,>>,1,&,cy,:=,#0,#1,>>=,$z,31,$s,s,:=,z,:=,0,ov,:=" },
	{ "shr", two (0x07e0, 0x0080), two (0x07e0, 0xffff), {R1, R2}, 0, V850_CPU_ALL, R_ANAL_OP_TYPE_SHR, "#1,tmp,:=,#0,1,-,tmp,>>,1,&,cy,:=,#0,#1,>>=,$z,31,$s,s,:=,z,:=,0,ov,:=" },
