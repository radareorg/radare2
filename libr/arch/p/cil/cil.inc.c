...
static const CilInstruction cil_instructions[256] = {
	...
	[0x27] = { "jmp", R_ANAL_OP_TYPE_JMP, 5, CIL_OP_TOKEN },
	[0x28] = { "call", R_ANAL_OP_TYPE_CALL, 5, CIL_OP_TOKEN },
	[0x29] = { "calli", R_ANAL_OP_TYPE_UCALL, 5, CIL_OP_TOKEN },
	...
	[0x76] = { "conv.r.un", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0x79] = { "unbox", R_ANAL_OP_TYPE_LOAD, 5, CIL_OP_TOKEN },
	[0x7a] = { "throw", R_ANAL_OP_TYPE_TRAP, 1, CIL_OP_NONE },
	...
	[0x81] = { "stobj", R_ANAL_OP_TYPE_STORE, 5, CIL_OP_TOKEN },
	[0x82] = { "conv.ovf.i1.un", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0x83] = { "conv.ovf.i2.un", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0x84] = { "conv.ovf.i4.un", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0x85] = { "conv.ovf.i8.un", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0x86] = { "conv.ovf.u1.un", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0x87] = { "conv.ovf.u2.un", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0x88] = { "conv.ovf.u4.un", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0x89] = { "conv.ovf.u8.un", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0x8a] = { "conv.ovf.i.un", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0x8b] = { "conv.ovf.u.un", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0x8c] = { "box", R_ANAL_OP_TYPE_LOAD, 5, CIL_OP_TOKEN },
	[0x8d] = { "newarr", R_ANAL_OP_TYPE_LOAD, 5, CIL_OP_TOKEN },
	[0x8e] = { "ldlen", R_ANAL_OP_TYPE_LOAD, 1, CIL_OP_NONE },
	[0x8f] = { "ldelema", R_ANAL_OP_TYPE_LOAD, 5, CIL_OP_TOKEN },
	[0x90] = { "ldelem.i1", R_ANAL_OP_TYPE_LOAD, 1, CIL_OP_NONE },
	[0x91] = { "ldelem.u1", R_ANAL_OP_TYPE_LOAD, 1, CIL_OP_NONE },
	[0x92] = { "ldelem.i2", R_ANAL_OP_TYPE_LOAD, 1, CIL_OP_NONE },
	[0x93] = { "ldelem.u2", R_ANAL_OP_TYPE_LOAD, 1, CIL_OP_NONE },
	[0x94] = { "ldelem.i4", R_ANAL_OP_TYPE_LOAD, 1, CIL_OP_NONE },
	[0x95] = { "ldelem.u4", R_ANAL_OP_TYPE_LOAD, 1, CIL_OP_NONE },
	[0x96] = { "ldelem.i8", R_ANAL_OP_TYPE_LOAD, 1, CIL_OP_NONE },
	[0x97] = { "ldelem.i", R_ANAL_OP_TYPE_LOAD, 1, CIL_OP_NONE },
	[0x98] = { "ldelem.r4", R_ANAL_OP_TYPE_LOAD, 1, CIL_OP_NONE },
	[0x99] = { "ldelem.r8", R_ANAL_OP_TYPE_LOAD, 1, CIL_OP_NONE },
	[0x9a] = { "ldelem.ref", R_ANAL_OP_TYPE_LOAD, 1, CIL_OP_NONE },
	[0x9b] = { "stelem.i", R_ANAL_OP_TYPE_STORE, 1, CIL_OP_NONE },
	[0x9c] = { "stelem.i1", R_ANAL_OP_TYPE_STORE, 1, CIL_OP_NONE },
	[0x9d] = { "stelem.i2", R_ANAL_OP_TYPE_STORE, 1, CIL_OP_NONE },
	[0x9e] = { "stelem.i4", R_ANAL_OP_TYPE_STORE, 1, CIL_OP_NONE },
	[0x9f] = { "stelem.i8", R_ANAL_OP_TYPE_STORE, 1, CIL_OP_NONE },
	[0xa0] = { "stelem.r4", R_ANAL_OP_TYPE_STORE, 1, CIL_OP_NONE },
	[0xa1] = { "stelem.r8", R_ANAL_OP_TYPE_STORE, 1, CIL_OP_NONE },
	[0xa2] = { "stelem.ref", R_ANAL_OP_TYPE_STORE, 1, CIL_OP_NONE },
	...
	[0xb3] = { "conv.ovf.i1", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0xb4] = { "conv.ovf.u1", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0xb5] = { "conv.ovf.i2", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0xb6] = { "conv.ovf.u2", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0xb7] = { "conv.ovf.i4", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0xb8] = { "conv.ovf.u4", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0xb9] = { "conv.ovf.i8", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0xba] = { "conv.ovf.u8", R_ANAL_OP_TYPE_CAST, 1, CIL_OP_NONE },
	[0xc2] = { "refanyval", R_ANAL_OP_TYPE_LOAD, 5, CIL_OP_TOKEN },
	[0xc3] = { "ckfinite", R_ANAL_OP_TYPE_TRAP, 1, CIL_OP_NONE },
...
static const CilInstruction cil_fe_instructions[256] = {
	...
	[0x19] = { "no.", R_ANAL_OP_TYPE_LOAD, 3, CIL_OP_I1 },
	...
	[0x1e] = { "readonly.", R_ANAL_OP_TYPE_LOAD, 2, CIL_OP_NONE },
};
