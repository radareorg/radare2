...
//}
//
//static char *get_basename(const char *pfname, int len) {
//	char *p;
//
...
//				pp ; 
//				pp = strtok_r (NULL, "\n", &extern_tok)) {
//				if ((keyw = strstr (pp, "Anonymous:")) != NULL || 
//					(keyw = strstr (pp, "AnonHugePages:")) != NULL) {
