...
static Rabin2Env env[] = {
	...
	{ "RABIN2_MACHO_CLASSNAMES_ONLY", "                      # only parse Mach-O ObjC/Swift class names" },
	{ "RABIN2_MACHO_NAMED_CLASSES_ONLY", "                      # skip synthetic Mach-O UnnamedClass entries" },
	{ "RABIN2_MACHO_NOFUNCSTARTS", "                      # if set it will ignore the FUNCSTART information" },
	{ "RABIN2_MACHO_NOMETHODS", "                      # avoid parsing Mach-O ObjC/Swift methods" },
