...
struct machine_info {
	...
	ut32	memory_size;		/* size of memory in bytes, capped at 2 GB */
	ut64	max_mem;			/* actual size of physical memory */
	ut32	physical_cpu;		/* number of physical CPUs now available */
	integer_t	physical_cpu_max;	/* max number of physical CPUs possible */
	ut32	logical_cpu;		/* number of logical cpu now available */
