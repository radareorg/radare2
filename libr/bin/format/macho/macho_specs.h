#ifndef _INCLUDE_R_BIN_MACHO_SPECS_H_
#define _INCLUDE_R_BIN_MACHO_SPECS_H_

typedef int integer_t;

// NOTE(eddyb) the following have been slightly modified to work under radare.

#include "macho_defines.h"

// HACK(eddyb) everything below is from the old macho_specs.h, should replace
// with proper original definitions.

#undef MACHO_

#if R_BIN_MACHO64
#define R_BIN_MACHO_WORD_SIZE 8
#define MACHO_(name) name##_64
#else
#define R_BIN_MACHO_WORD_SIZE 4
#define MACHO_(name) name
#endif

#define R_BIN_MACHO_SYMBOL_TYPE_EXT 0
#define R_BIN_MACHO_SYMBOL_TYPE_LOCAL 1
