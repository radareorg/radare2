...
R_API void MACH0_(get_class_t)(RBinFile *bf, RBinClass *klass, mach0_ut p, bool dupe, const RVecMach0Reloc *relocs, objc_cache_opt_info *oi);
R_API void MACH0_(get_category_t)(RBinFile *bf, RBinClass *klass, mach0_ut p, const RVecMach0Reloc *relocs, objc_cache_opt_info *oi);
