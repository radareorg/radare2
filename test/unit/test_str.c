...
bool test_r_str_binstr2str(void) {
  const char* one = r_str_binstr2str("0100100001100101011011000110110001101111001000000111010001101000011001010111001001100101");
  const char* two = r_str_binstr2str("011100110111010101110000011001010111001000100000011000110110111101101111011011000010000001101101011001010111001101110011011000010110011101100101");
  const char* three = r_str_binstr2str("           00100000001000000010000000100000001000000111001101110100011000010111001001110100011100110010000001110111011010010111010001101000001000000111001101110000011000010110001101100101");
  const char* four = r_str_binstr2str("01100110011010010110111001100100011100110010000001101110011011110111010000100000011000100110100101101110abcdef");
...
bool test_r_str_str2binstr(void) {
  const char* one = r_str_str2binstr("Hello there");
  const char* two = r_str_str2binstr("super cool message");
  const char* three = r_str_str2binstr("     starts with space");
  const char* four = r_str_str2binstr("super secret!?");
