...
bool test_r_big_cmp(void) {
    ...
    r_big_from_hexstr (b, "0xffffffffffffffff", 18);
    mu_assert_eq (-1, r_big_cmp (a, b), "Failed r_big_cmp");
    mu_assert_eq (1, r_big_cmp (b, a), "Failed r_big_cmp");
    mu_assert_eq (0, r_big_cmp (a, a), "Failed r_big_cmp");
    mu_assert_eq (0, r_big_cmp (b, b), "Failed r_big_cmp");
...
bool test_r_big_add(void) {
    ...
    r_big_from_hexstr (a, "-0x7fffffffffffffff", 19);
    r_big_from_hexstr (b, "0x7fffffffffffffff", 18);
    r_big_add (c, a, b);
    mu_assert_eq (0, r_big_to_int (c), "Failed r_big_add");
    r_big_add (c, b, a);
    mu_assert_eq (0, r_big_to_int (c), "Failed r_big_add");
...
bool test_r_big_mul(void) {
    ...
    r_big_from_hexstr (b, "-0x7fffffffffffffff", 19);
    r_big_mul (c, a, b);
    r_big_from_hexstr (b, "-0x3fffffffffffffff0000000000000001", 35);
    ...
    r_big_from_hexstr (b, "0x7fffffffffffffff", 18);
    r_big_mul (c, a, b);
    r_big_from_hexstr (b, "0x3fffffffffffffff0000000000000001", 34);
    mu_assert_eq (0, r_big_cmp (c, b), "Failed r_big_mul");
    r_big_from_hexstr (b, "0x7fffffffffffffff", 18);
    r_big_mul (c, b, a);
    r_big_from_hexstr (b, "0x3fffffffffffffff0000000000000001", 34);
...
bool test_r_big_div(void) {
    ...
    r_big_from_int (b, 5);
    r_big_div (c, a, b);
    r_big_from_hexstr (b, "0x1999999999999999", 18);
    mu_assert_eq (0, r_big_cmp (c, b), "Failed r_big_div");

    r_big_from_hexstr (a, "0x8000000000000000", 18);
    r_big_from_int (b, 0x8000);
    r_big_div (c, a, b);
    r_big_from_hexstr (b, "0x1000000000000", 15);
    mu_assert_eq (0, r_big_cmp (c, b), "Failed r_big_div");
...
bool test_r_big_rshift(void) {
    ...
    r_big_from_hexstr (a, "", 258);
