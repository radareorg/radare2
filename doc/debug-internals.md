...
Replay data is attached per checkpoint and per file descriptor. The debugger
can queue, clear, list, and apply those streams through commands such as
`dtsw`, `dtsra`, and `dtswj`.
