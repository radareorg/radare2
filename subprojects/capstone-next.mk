...
WRAP_wrap_git_revision:=a1b2e0d514b9b85e66c218775c206cdb98b36acf
...
capstone-next:
	if [ ! -d "capstone-next" -o "a1b2e0d514b9b85e66c218775c206cdb98b36acf" != "$(shell cd capstone-next 2>/dev/null && git rev-parse HEAD)" ]; then rm -rf "capstone-next"; ${MAKE} capstone-next_all; fi

capstone-next_all:
	git clone --no-checkout --depth=1 https://github.com/capstone-engine/capstone.git capstone-next
	cd capstone-next && git fetch --depth=1 origin a1b2e0d514b9b85e66c218775c206cdb98b36acf
