...
WRAP_wrap_git_revision:=a0201371719b5aaa91d318ab2898843718f92d1f
...
capstone-next:
	if [ ! -d "capstone-next" -o "a0201371719b5aaa91d318ab2898843718f92d1f" != "$(shell cd capstone-next 2>/dev/null && git rev-parse HEAD)" ]; then rm -rf "capstone-next"; ${MAKE} capstone-next_all; fi

capstone-next_all:
	git clone --no-checkout --depth=1 https://github.com/capstone-engine/capstone.git capstone-next
	cd capstone-next && git fetch --depth=1 origin a0201371719b5aaa91d318ab2898843718f92d1f
