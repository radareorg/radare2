...
WRAP_wrap_git_revision:=892677071130be857c9198d80231cc0cb90a466e
...
capstone-next:
	if [ ! -d "capstone-next" ] || ! (cd "capstone-next" 2>/dev/null && test "$$(git rev-parse HEAD 2>/dev/null)" = "$$(git rev-parse '892677071130be857c9198d80231cc0cb90a466e^{commit}' 2>/dev/null)"); then rm -rf "capstone-next"; ${MAKE} capstone-next_all; fi

capstone-next_all:
	git clone --no-checkout --depth=1 https://github.com/capstone-engine/capstone.git capstone-next
	cd capstone-next && git fetch --depth=1 origin 892677071130be857c9198d80231cc0cb90a466e
