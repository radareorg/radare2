...
capstone-next:
	if [ ! -d "capstone-next" ] || ! (cd "capstone-next" 2>/dev/null && test "$$(git rev-parse HEAD 2>/dev/null)" = "$$(git rev-parse '26d632ecf83967ad3981d65ca28f87ce0e393ec6^{commit}' 2>/dev/null)"); then rm -rf "capstone-next"; ${MAKE} capstone-next_all; fi
