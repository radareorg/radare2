...
WRAP_wrap_git_revision:=484857da5dc67f7d0e0a01c36b0ebc37a349e0fd
...
capstone-next:
	if [ ! -d "capstone-next" -o "484857da5dc67f7d0e0a01c36b0ebc37a349e0fd" != "$(shell cd capstone-next 2>/dev/null && git rev-parse HEAD)" ]; then rm -rf "capstone-next"; ${MAKE} capstone-next_all; fi

capstone-next_all:
	git clone --no-checkout --depth=1 https://github.com/capstone-engine/capstone.git capstone-next
	cd capstone-next && git fetch --depth=1 origin 484857da5dc67f7d0e0a01c36b0ebc37a349e0fd
