...
WRAP_wrap_git_revision:=a99c49cdd93dc6c3768c534c16a32626d7f5cfed
...
capstone-next:
	if [ ! -d "capstone-next" ] || ! (cd "capstone-next" 2>/dev/null && test "$$(git rev-parse HEAD 2>/dev/null)" = "$$(git rev-parse 'a99c49cdd93dc6c3768c534c16a32626d7f5cfed^{commit}' 2>/dev/null)"); then rm -rf "capstone-next"; ${MAKE} capstone-next_all; fi

capstone-next_all:
	git clone --no-checkout --depth=1 https://github.com/capstone-engine/capstone.git capstone-next
	cd capstone-next && git fetch --depth=1 origin a99c49cdd93dc6c3768c534c16a32626d7f5cfed
