...
WRAP_wrap_git_revision:=0bd647456e57ae17796937b9f296ef8bc1201b9e
...
capstone-v5:
	if [ ! -d "capstone-v5" -o "0bd647456e57ae17796937b9f296ef8bc1201b9e" != "$(shell cd capstone-v5 2>/dev/null && git rev-parse HEAD)" ]; then rm -rf "capstone-v5"; ${MAKE} capstone-v5_all; fi

capstone-v5_all:
	git clone --no-checkout --depth=1 https://github.com/capstone-engine/capstone.git capstone-v5
	cd capstone-v5 && git fetch --depth=1 origin 0bd647456e57ae17796937b9f296ef8bc1201b9e
