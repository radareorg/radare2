...
WRAP_wrap_git_revision:=cc6f8e0767738fc51c12eda6492d420e5db2c7a2
...
capstone-v5:
	if [ ! -d "capstone-v5" ] || ! (cd "capstone-v5" 2>/dev/null && test "$$(git rev-parse HEAD 2>/dev/null)" = "$$(git rev-parse 'cc6f8e0767738fc51c12eda6492d420e5db2c7a2^{commit}' 2>/dev/null)"); then rm -rf "capstone-v5"; ${MAKE} capstone-v5_all; fi

capstone-v5_all:
	git clone --no-checkout --depth=1 https://github.com/capstone-engine/capstone.git capstone-v5
	cd capstone-v5 && git fetch --depth=1 origin cc6f8e0767738fc51c12eda6492d420e5db2c7a2
