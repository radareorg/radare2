...
WRAP_wrap_git_revision:=51360daf925e50d4da383cff2278107e6ffd8074
...
capstone-v5:
	if [ ! -d "capstone-v5" ] || ! (cd "capstone-v5" 2>/dev/null && test "$$(git rev-parse HEAD 2>/dev/null)" = "$$(git rev-parse '51360daf925e50d4da383cff2278107e6ffd8074^{commit}' 2>/dev/null)"); then rm -rf "capstone-v5"; ${MAKE} capstone-v5_all; fi

capstone-v5_all:
	git clone --no-checkout --depth=1 https://github.com/capstone-engine/capstone.git capstone-v5
	cd capstone-v5 && git fetch --depth=1 origin 51360daf925e50d4da383cff2278107e6ffd8074
