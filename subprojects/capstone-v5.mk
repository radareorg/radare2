...
capstone-v5:
	if [ ! -d "capstone-v5" -o "c04e7f2a81b6f126263822398485878ca5f78bc3" != "$(shell cd capstone-v5 2>/dev/null && git rev-parse HEAD)" ]; then rm -rf "capstone-v5"; ${MAKE} capstone-v5_all; fi
