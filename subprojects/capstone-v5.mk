...
WRAP_wrap_git_revision:=f39c12aa3e0315ab065c3959242e70f4c4d6048e
...
capstone-v5:
	if [ ! -d "capstone-v5" ] || ! (cd "capstone-v5" 2>/dev/null && test "$$(git rev-parse HEAD 2>/dev/null)" = "$$(git rev-parse 'f39c12aa3e0315ab065c3959242e70f4c4d6048e^{commit}' 2>/dev/null)"); then rm -rf "capstone-v5"; ${MAKE} capstone-v5_all; fi

capstone-v5_all:
	git clone --no-checkout --depth=1 https://github.com/capstone-engine/capstone.git capstone-v5
	cd capstone-v5 && git fetch --depth=1 origin f39c12aa3e0315ab065c3959242e70f4c4d6048e
