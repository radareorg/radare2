...
WRAP_wrap_git_revision:=71ca8ff0669d8c0cab16d65a34bc48f1c0fcc27f
...
otezip:
	if [ ! -d "otezip" -o "71ca8ff0669d8c0cab16d65a34bc48f1c0fcc27f" != "$(shell cd otezip 2>/dev/null && git rev-parse HEAD)" ]; then rm -rf "otezip"; ${MAKE} otezip_all; fi

otezip_all:
	git clone --no-checkout --depth=1 https://github.com/trufae/otezip.git otezip
	cd otezip && git fetch --depth=1 origin 71ca8ff0669d8c0cab16d65a34bc48f1c0fcc27f
