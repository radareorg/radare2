...
WRAP_wrap_git_revision:=064d94494a41824042d5978f503f3bc8c44a8d49
...
otezip:
	if [ ! -d "otezip" -o "064d94494a41824042d5978f503f3bc8c44a8d49" != "$(shell cd otezip 2>/dev/null && git rev-parse HEAD)" ]; then rm -rf "otezip"; ${MAKE} otezip_all; fi

otezip_all:
	git clone --no-checkout --depth=1 https://github.com/trufae/otezip.git otezip
	cd otezip && git fetch --depth=1 origin 064d94494a41824042d5978f503f3bc8c44a8d49
