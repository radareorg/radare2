...
WRAP_wrap_git_revision:=3c95b773d02d4e6cd738a3091d70eecbcf78b148
...
otezip:
	if [ ! -d "otezip" -o "3c95b773d02d4e6cd738a3091d70eecbcf78b148" != "$(shell cd otezip 2>/dev/null && git rev-parse HEAD)" ]; then rm -rf "otezip"; ${MAKE} otezip_all; fi

otezip_all:
	git clone --no-checkout --depth=1 https://github.com/trufae/otezip.git otezip
	cd otezip && git fetch --depth=1 origin 3c95b773d02d4e6cd738a3091d70eecbcf78b148
