...
WRAP_wrap_git_revision:=569cf190a7e2a6589369811f358e8ee682bd4ff1
...
otezip:
	if [ ! -d "otezip" -o "569cf190a7e2a6589369811f358e8ee682bd4ff1" != "$(shell cd otezip 2>/dev/null && git rev-parse HEAD)" ]; then rm -rf "otezip"; ${MAKE} otezip_all; fi

otezip_all:
	git clone --no-checkout --depth=1 https://github.com/trufae/otezip.git otezip
	cd otezip && git fetch --depth=1 origin 569cf190a7e2a6589369811f358e8ee682bd4ff1
