...
WRAP_wrap_git_revision:=35be4db7a265e9f5eb3529d53af503f630880d5b
...
otezip:
	if [ ! -d "otezip" -o "35be4db7a265e9f5eb3529d53af503f630880d5b" != "$(shell cd otezip 2>/dev/null && git rev-parse HEAD)" ]; then rm -rf "otezip"; ${MAKE} otezip_all; fi

otezip_all:
	git clone --no-checkout --depth=1 https://github.com/trufae/otezip.git otezip
	cd otezip && git fetch --depth=1 origin 35be4db7a265e9f5eb3529d53af503f630880d5b
