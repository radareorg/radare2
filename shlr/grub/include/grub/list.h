...
#define GRUB_AS_LIST(ptr) \
	(GRUB_FIELD_MATCH (ptr, grub_list_t, next) ? (grub_list_t)ptr : grub_bad_type_cast ())

#define GRUB_AS_LIST_P(pptr) \
	(GRUB_FIELD_MATCH (*pptr, grub_list_t, next) ? (grub_list_t *)(void *)pptr : grub_bad_type_cast ())
