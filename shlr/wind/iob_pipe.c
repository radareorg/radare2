...
int iob_pipe_read (void *p, ut8 *buf, const ut64 count, const int timeout) {
    struct qemu_pipe_t *ptr = (struct qemu_pipe_t *)p;
...
int iob_pipe_write (void *p, ut8 *buf, const ut64 count, const int timeout) {
    struct qemu_pipe_t *ptr = (struct qemu_pipe_t *)p;
